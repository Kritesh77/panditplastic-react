...
class Slider2 extends Component{
    ...
    return(
        <section className="fourth-wrap review-container ">
            <h2 className="med">REAL REVIEWS FROM REAL CUSTOMERS
            ...
            <div>
                ...
                <div className="review-heading">
                    <h4 className="fw-600 ">Beautiful plants beautifully packaged. everything</h4>
                </div>
                <div className="review">
                    <div className="review-image">
                    <img src="./images/IMG_8753.jpg" alt="" />
                    </div>
                    <p className="fw-300-i reviewer-review">Beautiful plants packaged. everything arrived plump and healthy. Thank you!</p>
